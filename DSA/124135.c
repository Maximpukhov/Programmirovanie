...
int main() {
  int n = 100000; // Размер массива до 100 000
    int *array = (int *)malloc(n * sizeof(int)); // Динамическое выделение памяти для массива
    ...
    // Выберите один из следующих вариантов заполнения массива:

    // Вариант 1: случайные числа
    srand(time(NULL)); // Инициализация генератора случайных чисел
    // for (int i = 0; i < n; i++) {
    //     array[i] = rand() % 100000; // Генерация случайного числа до 100000
    // }

    // Вариант 2: числа от 0 до 100000
    for (int i = 0; i < n; i++) {
        array[i] = i; // Заполнение массива числами от 0 до n-1
    }

    // Вариант 3: числа от 100000 до 0
    // for (int i = 0; i < n; i++) {
    //     array[i] = 100000 - i; // Заполнение массива числами от 100000 до 100000-n+1
    // }
    int height = (int)ceil(log2(n));
    int maxSize = 2 * (int)pow(2, height) - 1;
