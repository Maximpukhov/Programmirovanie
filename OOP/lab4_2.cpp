...
int main()
{
    ...
    for (i = 0; i < 2; i++)
    {
        for (j = 0; j < 3; j++)
        {
            obj1.SetM(i, j, (i + j) * 0.5);
        }
    }
    cout << "obj1" << endl;
    obj1.prT_matrix();
    Matrix<double> obj2 = obj1; // вызов конструктора копирования
    cout << "obj2" << endl;
    obj2.prT_matrix();
    Matrix<double> obj3; // вызов оператора копирования - проверка
    obj3 = obj1;
    cout << "obj3" << endl;
    obj3.prT_matrix();
    Matrix<double> obj4;
